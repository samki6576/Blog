...
const featuredPosts = [
  {
    ...
    readTime: "5 min read",
    category: "Technology",
    image: "https://images.unsplash.com/photo-1642775196125-38a9eb496568?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8N3x8ZGF0YWJhc2V8ZW58MHx8MHx8fDA%3D",
    views: 1250,
    likes: 89,
    comments: 23,
    featured: true,
  },
  {
    ...
    image: "https://images.unsplash.com/photo-1504639725590-34d0984388bd?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTV8fGRhdGFiYXNlfGVufDB8fDB8fHww",
    views: 890,
    likes: 67,
    comments: 15,
  },
  {
    ...
    readTime: "6 min read",
    category: "Design",
    image: "https://images.unsplash.com/photo-1648459776041-cbeab708f17b?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTF8fGRhdGFiYXNlfGVufDB8fDB8fHww",
    views: 1100,
    likes: 92,
    comments: 31,
  },
      ...
      <footer className="bg-gray-900 text-white py-12 px-4">
        <div className="container mx-auto">
          ...
          <div className="border-t border-gray-800 mt-8 pt-8 text-center text-gray-400">
            <p>&copy; Website of Samra.2025</p>
          </div>
        </div>
      </footer>
    </div>
